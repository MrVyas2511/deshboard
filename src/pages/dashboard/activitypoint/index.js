  ...
  return (
    <div >
      <div className="apoint">
        ...
        <Typography variant="h3" className='head' gutterBottom component="div">
          Activity Points
        </Typography>

        <Typography variant="h6" className='alert' gutterBottom component="div">
          Have you added certificate details on GTU 100 Activity Portal?<br />
        ...
        <Button
          ...
          variant="contained"> Uplaod Certificate</Button>
